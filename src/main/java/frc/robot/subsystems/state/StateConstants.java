...
public class StateConstants {
    ...
    public static final Setpoint L3 = new Setpoint(ArmConstants.CORAL_L3, ElevatorConstants.STOW, 0.0, WristConstants.CORAL_L3_SETPOINT);
    ...
    public static final Setpoint LOW_ALGAE = new Setpoint(ArmConstants.ALGAE_LOW, ElevatorConstants.STOW, 1.0, null);
