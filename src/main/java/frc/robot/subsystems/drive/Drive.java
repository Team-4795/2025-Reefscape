...
public class Drive extends SubsystemBase {
    ...
    private final MutableMeasure<AngularVelocityUnit, AngularVelocity, MutAngularVelocity> m_velocity = new MutAngularVelocity(
    ...
    private SwerveDrivePoseEstimator poseEstimator = new SwerveDrivePoseEstimator(kinematics, rawGyroRotation2d,
        ...
        AutoBuilder.configure(
                ...
                new PPHolonomicDriveController( // PPHolonomicController is the built in path following controller for
                        ...
                        new PIDConstants(DriveConstants.TranslationKP, DriveConstants.TranslationKI,
                                DriveConstants.TranslationKD), // Translation PID constants
                        new PIDConstants(DriveConstants.RotationKP, DriveConstants.RotationKI,
                                DriveConstants.RotationKD) // Rotation PID constants
                ),
