...
public class RobotContainer {
  ...
  public static SwerveRequest.FieldCentric drive;
  ...
  private void configureBindings() {
    ...
    // new AutoAlignReef(
    //       new ProfiledPIDController(1, 0, 0, new Constraints(MaxSpeed, 5)), 
    //       new ProfiledPIDController(1, 0, 0, new Constraints(MaxSpeed, 5)), drivetrain, drive, joystick));
